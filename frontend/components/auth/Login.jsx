    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between p-12 bg-gradient-hero text-white overflow-hidden ml-40">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <span className="text-xl font-bold text-primary">StudyDeck</span>
        </div>
        ...
        <div className="relative space-y-6 max-w-md">
          ...
          <h1 className="text-5xl font-bold text-black/70">
            Flashcards for <span className="text-primary">effective studying</span>for students.
          </h1>

          <p className="text-black/70">
           Flip the cards to reveal answers and test your knowledge.
          </p>
        </div>
